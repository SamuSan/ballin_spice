...
describe EvaluateHands do
  describe "#call" do
    ...
    context "there is a pair in player_one_hand" do
      let(:expected_hand_evaluation) { { 'type' => 'one_pair', 'values' => [5], 'rank' => 1 } }
    ...
    context "there are two pair in player_one_hand" do
      ...
      let(:expected_hand_evaluation) { { 'type' => 'two_pair', 'values' => [5, 14], 'rank' => 2 } }
    ...
    context "there are three of a kind in player_one_hand" do
      ...
      let(:expected_hand_evaluation) { { 'type' =>  'three_of_a_kind', 'values' => [5], 'rank' => 3 } }
    ...
    context "there is a straight in player_one_hand" do
      ...
      let(:expected_hand_evaluation) { { 'type' => 'straight', 'values' => [5], 'rank' => 4 } }
    ...
    context "there is a flush in player_one_hand" do
      ...
      let(:expected_hand_evaluation) { { 'type' => 'flush', 'values' => [:c], 'rank' => 5 } }
    ...
    context "there is a full house in player_one_hand" do
      ...
      let(:expected_hand_evaluation) { { 'type' => 'full_house', 'values' => [5], 'rank' => 6 } }
    ...
    context "there are four of a kind in player_one_hand" do
      ...
      let(:expected_hand_evaluation) { { 'type' => 'four_of_a_kind', 'values' => [5], 'rank' => 7 } }
    ...
    context "there is a straight flush in player_one_hand" do
      ...
      let(:expected_hand_evaluation) { { 'type' => 'straight_flush', 'values' => [5], 'rank' => 8 } }
    ...
    context "there is a royal flush in player_one_hand" do
      ...
      let(:expected_hand_evaluation) { { 'type' => 'royal_flush', 'values' => [:c], 'rank' => 9 } }
